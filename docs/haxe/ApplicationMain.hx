...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("haxe-flixel-template", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("haxe-flixel-template", null, 480, 272);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "44";
		app.meta["company"] = "KinoCreatesGames";
		app.meta["file"] = "haxe-flixel-template";
		app.meta["name"] = "Love Defense";
